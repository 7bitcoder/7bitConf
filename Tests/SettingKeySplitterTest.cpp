...
// PARAMS_TEST_COMBINED_4(SettingSplitterTest, ShouldParseOptions, OptionPrefix, OptionsValues, TypeMarkers,
// KeySeparators)
//{
//     const auto &[prefix, params, typeMark, separator] = GetParam();
//     const auto &[key, type, value] = params;
//     sb::cf::details::SettingSplitter parser;
//
...
//     auto result = parser.split(setting);
//     EXPECT_EQ(result, expected);
// }
//
// PARAMS_TEST(SettingSplitterTest, ShouldParseOptionsRandom, OptionsValues)
//{
...
// };
// PARAMS_TEST(SettingSplitterTest, ShouldParseProblematicOptions, ProblematicOptionsValues)
//{
...
//                                                      "="
//                                                      "--="};
// PARAMS_TEST(SettingSplitterTest, ShouldFailParseOptions, FailOptionsValues)
//{
//     const auto &[setting] = GetParam();
//
//     sb::cf::details::SettingSplitter parser;
//
//     EXPECT_ANY_THROW(parser.split(setting));
// }