...
struct ConfigurationBuilderMock : public sb::cf::IConfigurationBuilder
{
    ...
    MOCK_METHOD((std::unordered_map<std::string, sb::cf::IObject::Ptr> &), getProperties, (), (override));
    MOCK_METHOD((const std::unordered_map<std::string, sb::cf::IObject::Ptr> &), getProperties, (), (const override));
